import { n as lt, s as le, t as fe } from "./scheduler.W2pu3yam.js";
...
var Dt;
const P =
  ((Dt = globalThis.__sveltekit_erq4tt) == null ? void 0 : Dt.base) ?? "";
var Ct;
const Pe =
    ((Ct = globalThis.__sveltekit_erq4tt) == null ? void 0 : Ct.assets) ?? P,
  Te = "1711898514874",
...
async function nt({
  ...
  const c = {
    ...
    props: { constructors: Fe(e).map((d) => d.node.component), page: I },
  };
...
async function ne({
    ...
    const E = y.branch[v],
      k =
        ...
        ((E == null ? void 0 : E.loader) !== p[1] ||
          jt(_, g, h, d, (x = E.server) == null ? void 0 : x.uses, r));
    return k && (_ = !0), k;
  });
  if (f.some(Boolean)) {
    try {
  ...
  const A = l.map(async (p, v) => {
    ...
    if (
      ...
      !jt(b, g, h, d, (it = E.universal) == null ? void 0 : it.uses, r)
    )
      return E;
    ...
    if (l[p])
      try {
        ...
        if (m != null && m.includes(v)) (E = v.status ?? E), (k = v.error);
          ...
          k = await C(v, { params: r, url: e, route: { id: a.id } });
        }
...
function Rt(t, n) {
  ...
  let e;
  try {
    e = q.hooks.reroute({ url: new URL(t) }) ?? t.pathname;
  } catch {
    return;
  }
  const r = re(e);
...
function C(t, n) {
  ...
  const e = X(t),
    r = He(t);
  return (
    q.hooks.handleError({ error: t, event: n, status: e, message: r }) ?? {
      message: r,
    }
  );
}
  ...
  (history.scrollRestoration = "manual"),
    ...
    T.addEventListener("click", (e) => {
      ...
      if (h !== void 0 && u === ft(location)) {
        ...
        if (((F = !0), vt(S), t(a), !c.replace_state)) return;
        F = !1;
      }
      e.preventDefault(),
        Y({
...
async function tn(
  ...
  l.props.page && (l.props.page.state = {}), ee(l, t);
}
